...
namespace IdentityApp.Authorization
{
    public class InvoiceOperations
    {
        ...
        public static OperationAuthorizationRequirement Approve = new OperationAuthorizationRequirement { Name = Constants.ApprovedOperationName };
        public static OperationAuthorizationRequirement Reject = new OperationAuthorizationRequirement { Name = Constants.RejectedOperationName };
    }
    ...
    public class Constants
    {
        ...
        public static readonly string InvoiceManagersRole = "InvoiceManager"; // Role name we can assign to a user later on
